class ElementsCtrl {
    constructor() {
        ...
        this.testTitle = 'Elements page';
        this.orderByField = 'product';
        this.orderInvoice = 'date';
        this.reverseSort = false;
        this.isOpenPopup = false;
        this.tab = 1;
        this.box1 = this.box2 = this.box3 = this.box4 = false;
    ...
    pie() {
        ...
        function generatePie() {
            ...
            var data = [
                { value: 13000, text: 'Voice - Business Line'},
                { value: 7000, text: 'GigE Internet - Fixed 1000Mbps'},
                { value: 8000, text: 'E100 Internet - Burstable'},
            ];
            updatePie(data);
        }
...
$(document).on('click', '.mobile-arrow', function () {
    $(this).toggleClass('active');
    $('.account-area').slideToggle();
});



export default ElementsCtrl;