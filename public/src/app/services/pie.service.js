export default class PieService {
    constructor(AppConstants, $http, $state, $timeout) {
        'ngInject';
    ...
    balanceData() {
        var data = [
                { value: 13171, text: 'Voice - Business Line', formatVal: '13,171.95' },
                { value: 8781, text: 'GigE Internet - Fixed 1000Mbps', formatVal: '8,781.37' },
                { value: 7317, text: 'E100 Internet - Burstable', formatVal: '7317.91'},
            ];
        return data;
    }
    
    init() {
        var balanceData = this.balanceData();
        var margin = {
            top: 10,
            bottom: 10,
            left: 10,
        ...
        var innerRadius = outerRadius * 0.83; // 40%
        ...
        this._$timeout(generatePie(), 1000);
